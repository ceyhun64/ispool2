  ...
  return (
    ...
    >
      <Link href={`/products/${product.id}`}>
        <div className="relative aspect-[3/4] w-full overflow-hidden bg-white shadow-sm rounded-md">
          {/* Favori Butonu */}
          <button
