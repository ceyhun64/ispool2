  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 px-4">
    {[...Array(4)].map((_, i) => (
      <div key={i} className="space-y-4">
        <Skeleton className="aspect-[3/4] w-full bg-slate-100 " />
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-8">
          ...
          <div className="flex items-center gap-2.5">
            <button
              ...
              className="group flex items-center justify-center w-11 h-11  border border-slate-200 hover:bg-slate-950 transition-all duration-300"
              aria-label="Geri"
            >
              <ChevronLeft
        ...
        <div className="relative">
          ...
          <div className="mt-12 flex items-center justify-between border-t border-slate-100 pt-6">
            <div className="flex items-center gap-5">
              ...
              <div className="relative h-1 w-32 bg-slate-100  overflow-hidden">
                <motion.div
                  initial={false}
                  animate={{
